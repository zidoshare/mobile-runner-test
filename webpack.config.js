...
const common = {
  ...
  devHtml: path.join(srcPath, 'templates', 'dev.html'),
  prodHtml: path.join(srcPath, 'templates', 'prod.html'),
...
if (isDev) {
  common.plugins = [
    new HtmlWebpackPlugin({
      template: common.devHtml,
      inject: 'body',
      favicon: path.join(imagePath, 'cyd-logo.png'),
    }),
